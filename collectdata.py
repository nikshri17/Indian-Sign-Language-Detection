...
while True:
    ...
    cv2.putText(img, "0: " + str(count['zero']), (10, 15),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "a: " + str(count['a']), (10, 30),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "b: " + str(count['b']), (10, 45),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "c: " + str(count['c']), (10, 60),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "d: " + str(count['d']), (10, 75),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "e: " + str(count['e']), (10, 90),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "f: " + str(count['f']), (10, 105),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "g: " + str(count['g']), (10, 120),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "h: " + str(count['h']), (10, 135),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "i: " + str(count['i']), (10, 150),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "j: " + str(count['j']), (10, 165),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "k: " + str(count['k']), (10, 180),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "l: " + str(count['l']), (10, 195),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "m: " + str(count['m']), (10, 210),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "n: " + str(count['n']), (10, 225),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "o: " + str(count['o']), (10, 240),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "p: " + str(count['p']), (10, 255),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "q: " + str(count['q']), (10, 270),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "r: " + str(count['r']), (10, 285),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "s: " + str(count['s']), (10, 300),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "t: " + str(count['t']), (10, 315),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "u: " + str(count['u']), (10, 330),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "v: " + str(count['v']), (10, 345),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "w: " + str(count['w']), (10, 360),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "x: " + str(count['x']), (10, 375),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "y: " + str(count['y']), (10, 390),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "z: " + str(count['z']), (10, 405),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, str(DataFor), (100, 20),
                cv2.FONT_HERSHEY_PLAIN, 1.3, (0, 0, 255), 1)
    cv2.putText(img, "Total : " + str(total), (100, 50),
    ...
    # bounding box
    cv2.rectangle(img, (219, 9), (621, 419), (0, 255, 0), 1)
    ...
    result, RegionOfInterest = cv2.threshold(
        threshold, minVal, 255, cv2.THRESH_BINARY_INV + cv2.THRESH_OTSU)
    ...
    if interrupt & 0xFF == ord('0'):
        cv2.imwrite(folder + '0/' +
                    str(count['zero']) + '.jpg', RegionOfInterest)
