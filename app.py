...
class Application:
    ...
    def action_call(self):
        ...
        self.tx.config(text="DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING \n\n"
                            "Efforts By - \n"
                            "1.Meghna Gupta \n"
                            "2.Nitika Shrivastava \n "
                            "3.Kaushik Pranay \n "
                            "4.Dheeraj Sadani \n\n "
                            "Under the Supervision of\n"
                            "Project Guide:- Prof. Sanjay Pal \n"
                            "Project Coordinator:- Prof. Imran Ali Khan \n"
